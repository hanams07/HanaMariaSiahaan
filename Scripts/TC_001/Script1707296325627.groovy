...
WebUI.click(findTestObject('Object Repository/Login/Page_Advantage Shopping/path_CHECKOUT  (0.00)_menuUserSVGPath'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Login/Page_Advantage Shopping/span_SPEAKERS'), 'SPEAKERS')
